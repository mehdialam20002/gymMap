 ...
 * a reviewer can see the whole budget at once instead of inferring it from decorators.
 *
...
/** The closed set. A route outside it fails PG-5. */
...
export const RateLimit = (rateLimitClass: RateLimitClass) =>
  applyDecorators(
    SetMetadata(RATE_LIMIT_CLASS, rateLimitClass),
    ApiExtension('x-gymmap-rate-limit', rateLimitClass),
  );
